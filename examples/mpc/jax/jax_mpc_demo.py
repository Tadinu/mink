...
from mink.mjpc.jax_mpc import predictive_sampling
from tasks.bimanual import handover
import numpy as np

sim_model_cpu, plan_model_cpu, cost_fn, instruction_fn = handover.get_models_and_cost_fn()
...
_, _, costs, trajectories = jax.jit(
